...
const Hero = () => {
    return (
        ...
        <div className="relative md:left-10 left-2 top-24 xl:w-[45%] flex flex-col justify-center items-start max-xl:px-8 sm:p-16">
            <h1 className="home-1 md:text-[3.5rem] text-[2rem] bg-pink">Dress to Impress
                <span className="md:text-[3.5rem] text-[2.5rem] font-[600] font-sans-serif italic">Collection!</span>
            </h1>
            <h1 className="home-2 md:text-[3.5rem] text-[2.5rem] font-[600] font-sans-serif italic">Happy clothes</h1>
            <p className="home-3">Find happiness in every piece and express your unique style</p>
        </div>
    </section>
    )    
}
