...
const Hero = () => {
    return (
        <section id="home" className='text-white min-h-screen'>
            ...
            <span className='md:text-[3.5rem] text-[2.5rem] font-[600] font-serif italic'>Collection!</span> </h1>
            <h1 className='home-2 md:text-[3.5rem] text-[2.5rem] font-[600] font-serif italic'>Happy clothes</h1>
