...
const Subscribe = () => {
  ...
  return (
    ...
    <section id="contact-us" className="bg-[#f8f6f2] container max-sm:mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 px-12">
       <div>
      <h3 className="text-4xl leading-[68px] text-center font-bold text-black">
        About Us
      </h3>
      ...
      <div>
      <h3 className="text-4xl leading-[68px] ml-8 text-center font-bold text-black">
        Connect with us on
      ...
      <div className="lg:max-w-[100%] w-full flex items-center flex-col gap-5 p-2.5 sm:border sm:border-slate-gray rounded-full">
        ...
        <input
          ...
          onChange={handleInputChange}
        />
        <button className="buttonProducts ml-4 px-2 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
          Subscribe
        </button>
        </div>
      </div>
