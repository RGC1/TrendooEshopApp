    ...
    <footer id="footer" className="bg-[#545454] py-16">
      <div className="container max-sm:mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 px-12">
        ...
        <div>
          ...
          <ul>
            <li className="mb-3"><a href="#nav" className="no-underline text-white">Home</a></li>
            <li className="mb-3"><a href="#about" className="no-underline text-white">About Us</a></li>
            <li className="mb-3"><a href="#reviews" className="no-underline text-white">Reviews</a></li>
            <li className="mb-3"><a href="#subscribe" className="no-underline text-white">Subscribe Now!</a></li>
        ...
        <a href="#" className="fixed bottom-4 right-4 bg-gray-800 text-white p-2 rounded-full shadow-md transition duration-300 hover:bg-gray-700 hover:text-gray-200">
